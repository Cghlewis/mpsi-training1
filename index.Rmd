...
Source: [OSF](https://osf.io) and [Jessica Logan, Ph.D](https://figshare.com/articles/Data_Management_and_Data_Management_Plans/7890827)
...
* You can make wikis specific to a project and house frequently used information (ex: Recruitment Information)

* Or a general research team wiki that houses 
  + Frequently requested information (ex: meeting notes or employee manual)
  + Information that is relevant across research projects (ex: file naming conventions or folder structure conventions)
...
* Are we collecting data over time? 
  ...
  + What do we want to name variables like Cohort, Year, or Time? 
      + What do we want those values to be?
...
Next training on *Setting up Your Data Structures* will be Friday 10/30/2020? at 2pm
